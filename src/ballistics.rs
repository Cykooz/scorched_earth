...
impl Ballistics {
    ...
    #[inline]
    pub fn pos_and_velocity(&self) -> (Point2, Vector2) {
        (
...
mod tests {
    ...
    fn test_positions_iter_horizontal() {
        ...
        assert_eq!(ballistics.last_updated, 10.0);
        assert_eq!(ballistics.cur_pos.x, 1000.0);
        ...
        assert_eq!(pos_iterator.next(), None);
        assert_eq!(ballistics.last_updated, 20.0);
        assert_eq!(ballistics.cur_pos.x, 2000.0);
    }
    ...
    fn test_positions_iter_vertical() {
        ...
        assert_eq!(pos_iterator.next(), None);
        assert_eq!(ballistics.last_updated, 10.0);
        assert_eq!(ballistics.cur_pos.y, -1000.0);
    }
}
